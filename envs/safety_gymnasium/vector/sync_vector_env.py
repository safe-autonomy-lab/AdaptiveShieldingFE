...
from envs.safety_gymnasium.vector.utils.tile_images import tile_images
...
class SafetySyncVectorEnv(SyncVectorEnv):
    ...
    def step_wait(
        ...
        # Convert observations to numpy arrays if they're tensors
    ...
    def render_rgb_array(self) -> np.ndarray:
        return self.envs[0].render_rgb_array()
