...
from .custom_button_configs import button_level0_config


class CustomButtonLevel2(CustomButtonLevel1):
    """An agent must press a goal button while obstacles customized.
    Level 2 means that out of distribution obstacles are added.
    """
