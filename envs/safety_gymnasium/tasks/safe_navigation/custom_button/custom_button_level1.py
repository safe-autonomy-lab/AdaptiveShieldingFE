...
class CustomButtonLevel1(CustomButtonLevel0):
    """An agent must press a goal button while obstacles customized.
    Level 1 means that out of distribution obstacles are added.
    """
    ...
    def __init__(self, config) -> None: 
        ...
        print(nbr_of_hazards, nbr_of_pillars, nbr_of_apples, nbr_of_oranges, nbr_of_gremlins, nbr_of_vases)
