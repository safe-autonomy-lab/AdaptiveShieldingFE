...
def __register_helper(env_id, entry_point, spec_kwargs=None, **kwargs):
    ...
    gymnasium_register(
        ...
        entry_point='envs.safety_gymnasium.wrappers.gymnasium_conversion:make_gymnasium_environment',
...
def __combine(tasks, agents, max_episode_steps):
    ...
    for task_name, task_config in tasks.items():
        ...
        for robot_name in agents:
            ...
            __register_helper(
                env_id=env_id,
                entry_point='envs.safety_gymnasium.builder:Builder',
...
__register_helper(
    ...
    entry_point='envs.safety_gymnasium.tasks.safe_velocity.safety_hopper_velocity_v0:SafetyHopperVelocityEnv',
    max_episode_steps=1000,
...
__register_helper(
    ...
    max_episode_steps=1000,
    entry_point='envs.safety_gymnasium.tasks.safe_velocity.safety_walker2d_velocity_v0:SafetyWalker2dVelocityEnv',
)

__register_helper(
    env_id='SafetyAntVelocity-v0',
    entry_point='envs.safety_gymnasium.tasks.safe_velocity.safety_ant_velocity_v0:SafetyAntVelocityEnv',
    max_episode_steps=1000,
...
__register_helper(
    ...
    entry_point='envs.safety_gymnasium.tasks.safe_velocity.safety_humanoid_velocity_v0:SafetyHumanoidVelocityEnv',
    max_episode_steps=1000,
)
...
__register_helper(
    ...
    entry_point='envs.safety_gymnasium.tasks.safe_velocity.safety_hopper_velocity_v1:SafetyHopperVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=3800.0,
)
...
__register_helper(
    ...
    max_episode_steps=1000,
    entry_point='envs.safety_gymnasium.tasks.safe_velocity.safety_walker2d_velocity_v1:SafetyWalker2dVelocityEnv',
)

__register_helper(
    env_id='SafetyAntVelocity-v1',
    entry_point='envs.safety_gymnasium.tasks.safe_velocity.safety_ant_velocity_v1:SafetyAntVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
...
__register_helper(
    ...
    entry_point='envs.safety_gymnasium.tasks.safe_velocity.safety_humanoid_velocity_v1:SafetyHumanoidVelocityEnv',
    max_episode_steps=1000,
)
...
def __combine_multi(tasks, agents, max_episode_steps):
    ...
    for task_name, task_config in tasks.items():
        ...
        for robot_name in agents:
            ...
            __register_helper(
                env_id=env_id,
                entry_point='envs.safety_gymnasium.tasks.safe_multi_agent.builder:Builder',
                spec_kwargs={'config': combined_config, 'task_id': env_id},
                max_episode_steps=max_episode_steps,
