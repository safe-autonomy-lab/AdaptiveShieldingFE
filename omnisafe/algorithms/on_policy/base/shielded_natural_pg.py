...
class ShieldedNaturalPG(ShieldedPolicyGradient):
    ...
    def _update_actor(  # pylint: disable=too-many-arguments,too-many-locals
        ...
        Args:
            ...
            shield_adv_c (torch.Tensor): The shield cost advantage tensor.
        Raises:
    ...
    def _update(self) -> None:
        ...
        dataloader = DataLoader(
            dataset=TensorDataset(obs, act, target_value_r, target_value_c, adv_c, target_shield_violation, shield_adv_c),
        ...
        self._logger.store(
            {
                ...
                'Safety/shield_adv_c': shield_adv_c.mean().item(),
            },
        )
