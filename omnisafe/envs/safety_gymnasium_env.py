...
import numpy as np
import envs.safety_gymnasium as safety_gymnasium
...
class SafetyGymnasiumEnv(CMDP):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if num_envs > 1:
            self._env = vector.make(env_id=env_id, num_envs=num_envs, **kwargs)
            ...
            self._env = make(id=env_id, autoreset=False, **kwargs)
