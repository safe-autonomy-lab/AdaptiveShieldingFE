...
class CartPole(BenchmarkEnv):
    ...
    def step(self, action):
        ...
        Returns:
            ...
            dict: A dictionary with information about constraints and hidden parameters.
        """
        ...
        self.state = np.hstack(
            (p.getJointState(self.CARTPOLE_ID, jointIndex=0,
             ...
             p.getJointState(self.CARTPOLE_ID, jointIndex=1, 
                             physicsClientId=self.PYB_CLIENT)[0:2]))
        # Standard Gym return.
        ...
        # Add hidden parameters to info before after_step
        info["hidden_parameters"] = {
            "pole_length": self.OVERRIDDEN_EFFECTIVE_POLE_LENGTH,
    ...
    def reset(self):
        ...
        # Generate random multipliers between 0.5 and 1.5
        multipliers = {
            "pole_length": np.random.uniform(0.5, 1.5),
            "cart_mass": np.random.uniform(0.5, 1.5),
            "pole_mass": np.random.uniform(0.5, 1.5)
        }

        # Apply multipliers to initial values
        prop_values = {
        ...
        self.OVERRIDDEN_EFFECTIVE_POLE_LENGTH = prop_values["pole_length"]  * multipliers["pole_length"]
        self.OVERRIDDEN_CART_MASS = prop_values["cart_mass"] * multipliers["cart_mass"]
        self.OVERRIDDEN_POLE_MASS = prop_values["pole_mass"] * multipliers["pole_mass"]
        ...
        # Add multipliers to info dictionary
        self.hidden_parameters = multipliers
